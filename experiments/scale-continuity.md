...
Smallest prototype: TartanAir V2 ArchViz Tiny House SDF Cell across object, room, and site anchor depths.
Input dataset: provenance-bound TartanAir V2 validation Origin.
...
Power House integration: Presentation transforms preserve the `0.3.0` Cell and
...
Decision: Supported for the continuous bounded `0.3.0` scale field. Broader
