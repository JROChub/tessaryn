...
pub fn verify_cinematic_object(
    ...
    Ok(CinematicObjectReportV1 {
        ...
        media_width: envelope.descriptor.media.width,
        media_height: envelope.descriptor.media.height,
        media_codec: envelope.descriptor.media.codec,
        moments: envelope.descriptor.moments.len(),
